...
Click Create Attestor
    ...
    Enter key Version Resource Id
        projects/gcp-pse-457515/locations/us-east5/keyRings/udemy-cloud-run-kms-key-ring/cryptoKeys/cloud-monkey-kms-key-for-binary-authorization/cryptoKeyVersions/1
